...
@Component({
  selector: 'app-candidat-list3-dialog',
  templateUrl: './candidat-list3-dialog.component.html',
  styleUrls: ['./candidat-list3-dialog.component.css']
})
export class CandidatList3DialogComponent implements OnInit {
  ...
  constructor(private formBuilder : FormBuilder ,
    ...
    private dialogRef : MatDialogRef<CandidatList3DialogComponent>) { }
